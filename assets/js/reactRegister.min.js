...
const DateP = props => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", null, usedLabel, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)((react_datepicker__WEBPACK_IMPORTED_MODULE_2___default()), {
    selected: value,
...
Button.propTypes = {
  label: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().string),
  type: prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOf(['success', 'warning', 'danger', 'primary', 'secondary']).isRequired,
...
const App = () => {
  ...
  switch (currentStep) {
    ...
    case 2:
      usedForm = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "Hayyoo");
      break;
  }
