...
const DateP = props => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", null, usedLabel, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)((react_datepicker__WEBPACK_IMPORTED_MODULE_3___default()), {
    selected: value,
...
Button.propTypes = {
  label: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().string),
  type: prop_types__WEBPACK_IMPORTED_MODULE_2___default().oneOf(['success', 'warning', 'danger', 'primary', 'secondary']).isRequired,
  callback: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().func.isRequired)
};
...
Step.propTypes = {
  current: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().number.isRequired)
};
