...
/***/ "./assets/scripts/react/register/forms.js":
/*!************************************************!*\
  !*** ./assets/scripts/react/register/forms.js ***!
  \************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "DateP": function() { return /* binding */ DateP; },
/* harmony export */   "Input": function() { return /* binding */ Input; },
/* harmony export */   "Loading": function() { return /* binding */ Loading; },
/* harmony export */   "Select": function() { return /* binding */ Select; },
/* harmony export */   "SelectMultiple": function() { return /* binding */ SelectMultiple; }
/* harmony export */ });
...
const Input = props => {
  var _props$type, _props$name, _props$label, _props$placeholder;

  const [value, setValue] = useState(props.value);
  const usedType = (_props$type = props.type) !== null && _props$type !== void 0 ? _props$type : 'text';
  const usedName = (_props$name = props.name) !== null && _props$name !== void 0 ? _props$name : 'name';
  const usedLabel = (_props$label = props.label) !== null && _props$label !== void 0 ? _props$label : 'Name';
  ...
  const usedPlaceholder = (_props$placeholder = props.placeholder) !== null && _props$placeholder !== void 0 ? _props$placeholder : '';
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", null, usedLabel, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: usedType,
    name: usedName,
    value: value,
...
const Select = props => {
  var _props$name2, _props$label2;

  const [value, setValue] = useState(props.value);
  const usedName = (_props$name2 = props.name) !== null && _props$name2 !== void 0 ? _props$name2 : 'name';
  const usedLabel = (_props$label2 = props.label) !== null && _props$label2 !== void 0 ? _props$label2 : 'Name';
  ...
  props.options.map(opt => {
    usedOptions.push((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", null, opt));
  });
  useEffect(() => {// console.log(value)
  }, [value]);
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", null, usedLabel, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("select", {
    name: usedName,
    onChange: onChange
  }, usedOptions)));
};
...
const DateP = props => {
  ...
  const usedLabel = (_props$label3 = props.label) !== null && _props$label3 !== void 0 ? _props$label3 : 'Name';
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", null, usedLabel, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)((react_datepicker__WEBPACK_IMPORTED_MODULE_4___default()), {
    selected: value,
...
const Button = props => {
  ...
  const usedLabel = (_props$label4 = props.label) !== null && _props$label4 !== void 0 ? _props$label4 : 'Button';
...
Button.propTypes = {
  label: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().string),
  type: prop_types__WEBPACK_IMPORTED_MODULE_3___default().oneOf(['success', 'warning', 'danger', 'primary', 'secondary']).isRequired,
  callback: (prop_types__WEBPACK_IMPORTED_MODULE_3___default().func.isRequired)
};

const SelectMultiple = props => {
  var _props$label5, _props$options;

  const [value, setValue] = useState([]);
  const usedLabel = (_props$label5 = props.label) !== null && _props$label5 !== void 0 ? _props$label5 : 'Name';
  const usedOptions = (_props$options = props.options) !== null && _props$options !== void 0 ? _props$options : []; // const options = [
  //     {label: "Grapes 🍇", value: "grapes"},
  //     {label: "Mango 🥭", value: "mango"},
  //     {label: "Strawberry 🍓", value: "strawberry", disabled: true},
  // ]

  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", null, usedLabel, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_multi_select_component__WEBPACK_IMPORTED_MODULE_1__.MultiSelect, {
    options: usedOptions,
    value: value,
    onChange: setValue,
    labelledBy: "Select"
...
const Loading = props => {
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: 'frow gutters'
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: 'col-sm-1-1'
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: 'text-center'
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)((react_loading__WEBPACK_IMPORTED_MODULE_2___default()), {
    type: 'cylon',
    color: '#737',
    height: 64,
    width: 64
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Dropdown": function() { return /* binding */ Z; },
/* harmony export */   "MultiSelect": function() { return /* binding */ rt; },
/* harmony export */   "SelectItem": function() { return /* binding */ M; },
/* harmony export */   "SelectPanel": function() { return /* binding */ J; }
/* harmony export */ });
...
`);var Re={allItemsAreSelected:"All items are selected.",clearSearch:"Clear Search",clearSelected:"Clear Selected",noOptions:"No options",search:"Search",selectAll:"Select All",selectAllFiltered:"Select All (Filtered)",selectSomeItems:"Select...",create:"Create"},He={value:[],hasSelectAll:!0,className:"multi-select",debounceDuration:200,options:[]},ie=react__WEBPACK_IMPORTED_MODULE_0___default().createContext({}),ce=({props:e,children:r})=>{let[t,n]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(e.options),a=c=>{var u;return((u=e.overrideStrings)==null?void 0:u[c])||Re[c]};return (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{n(e.options)},[e.options]),react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ie.Provider,{value:le($($({t:a},He),e),{options:t,setOptions:n})},r)},O=()=>react__WEBPACK_IMPORTED_MODULE_0___default().useContext(ie);function de(e,r){let t=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(!1);(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{t.current?e():t.current=!0},r)}var Ye={when:!0,eventTypes:["keydown"]};function E(e,r,t){let n=(0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(()=>Array.isArray(e)?e:[e],[e]),a=Object.assign({},Ye,t),{when:c,eventTypes:u}=a,b=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(r),{target:s}=a;(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{b.current=r});let m=(0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(i=>{n.some(l=>i.key===l||i.code===l)&&b.current(i)},[n]);(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{if(c&&typeof window<"u"){let i=s?s.current:window;return u.forEach(l=>{i&&i.addEventListener(l,m)}),()=>{u.forEach(l=>{i&&i.removeEventListener(l,m)})}}},[c,u,n,s,r])}var f={ARROW_DOWN:"ArrowDown",ARROW_UP:"ArrowUp",ENTER:"Enter",ESCAPE:"Escape",SPACE:"Space"};var pe=(e,r)=>{let t;return function(...n){clearTimeout(t),t=setTimeout(()=>{e.apply(null,n)},r)}};function ue(e,r){return r?e.filter(({label:t,value:n})=>t!=null&&n!=null&&t.toLowerCase().includes(r.toLowerCase())):e}var F=()=>react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg",{width:"24",height:"24",fill:"none",stroke:"currentColor",strokeWidth:"2",className:"dropdown-search-clear-icon gray"},react__WEBPACK_IMPORTED_MODULE_0___default().createElement("line",{x1:"18",y1:"6",x2:"6",y2:"18"}),react__WEBPACK_IMPORTED_MODULE_0___default().createElement("line",{x1:"6",y1:"6",x2:"18",y2:"18"}));var qe=({checked:e,option:r,onClick:t,disabled:n})=>react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:`item-renderer ${n&&"disabled"}`},react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input",{type:"checkbox",onChange:t,checked:e,tabIndex:-1,disabled:n}),react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span",null,r.label)),fe=qe;var Ge=({itemRenderer:e=fe,option:r,checked:t,tabIndex:n,disabled:a,onSelectionChanged:c,onClick:u})=>{let b=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(),s=l=>{m(),l.preventDefault()},m=()=>{a||c(!t)},i=l=>{m(),u(l)};return E([f.ENTER,f.SPACE],s,{target:b}),react__WEBPACK_IMPORTED_MODULE_0___default().createElement("label",{className:`select-item ${t&&"selected"}`,role:"option","aria-selected":t,tabIndex:n,ref:b},react__WEBPACK_IMPORTED_MODULE_0___default().createElement(e,{option:r,checked:t,onClick:i,disabled:a}))},M=Ge;var Je=({options:e,onClick:r,skipIndex:t})=>{let{disabled:n,value:a,onChange:c,ItemRenderer:u}=O(),b=(s,m)=>{n||c(m?[...a,s]:a.filter(i=>i.value!==s.value))};return react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment),null,e.map((s,m)=>{let i=m+t;return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li",{key:(s==null?void 0:s.key)||m},react__WEBPACK_IMPORTED_MODULE_0___default().createElement(M,{tabIndex:i,option:s,onSelectionChanged:l=>b(s,l),checked:!!a.find(l=>l.value===s.value),onClick:l=>r(l,i),itemRenderer:u,disabled:s.disabled||n}))}))},be=Je;var Xe=()=>{let{t:e,onChange:r,options:t,setOptions:n,value:a,filterOptions:c,ItemRenderer:u,disabled:b,disableSearch:s,hasSelectAll:m,ClearIcon:i,debounceDuration:l,isCreatable:W,onCreateOption:C}=O(),k=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(),g=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(),[p,D]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(""),[x,_]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(t),[y,T]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(""),[I,A]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0),R=(0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(pe(o=>T(o),l),[]),P=(0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(()=>{let o=0;return s||(o+=1),m&&(o+=1),o},[s,m]),H={label:e(p?"selectAllFiltered":"selectAll"),value:""},B=o=>{let d=x.filter(w=>!w.disabled).map(w=>w.value);if(o){let Me=[...a.map(V=>V.value),...d];return(c?x:t).filter(V=>Me.includes(V.value))}return a.filter(w=>!d.includes(w.value))},U=o=>{let d=B(o);r(d)},h=o=>{R(o.target.value),D(o.target.value),A(0)},N=()=>{var o;T(""),D(""),(o=g==null?void 0:g.current)==null||o.focus()},te=o=>A(o),ke=o=>{switch(o.code){case f.ARROW_UP:oe(-1);break;case f.ARROW_DOWN:oe(1);break;default:return}o.stopPropagation(),o.preventDefault()};E([f.ARROW_DOWN,f.ARROW_UP],ke,{target:k});let Ee=()=>{A(0)},re=async()=>{let o={label:p,value:p,__isNew__:!0};C&&(o=await C(p)),n([o,...t]),N(),r([...a,o])},Ie=async()=>c?await c(t,y):ue(t,y),oe=o=>{let d=I+o;d=Math.max(0,d),d=Math.min(d,t.length+Math.max(P-1,0)),A(d)};(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{var o,d;(d=(o=k==null?void 0:k.current)==null?void 0:o.querySelector(`[tabIndex='${I}']`))==null||d.focus()},[I]);let[Ae,Pe]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(()=>{let o=x.filter(d=>!d.disabled);return[o.every(d=>a.findIndex(w=>w.value===d.value)!==-1),o.length!==0]},[x,a]);(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{Ie().then(_)},[y,t]);let ne=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)();E([f.ENTER],re,{target:ne});let Ne=W&&p&&!x.some(o=>(o==null?void 0:o.value)===p);return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"select-panel",role:"listbox",ref:k},!s&&react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"search"},react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input",{placeholder:e("search"),type:"text","aria-describedby":e("search"),onChange:h,onFocus:Ee,value:p,ref:g,tabIndex:0}),react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button",{type:"button",className:"search-clear-button",hidden:!p,onClick:N,"aria-label":e("clearSearch")},i||react__WEBPACK_IMPORTED_MODULE_0___default().createElement(F,null))),react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul",{className:"options"},m&&Pe&&react__WEBPACK_IMPORTED_MODULE_0___default().createElement(M,{tabIndex:P===1?0:1,checked:Ae,option:H,onSelectionChanged:U,onClick:()=>te(1),itemRenderer:u,disabled:b}),x.length?react__WEBPACK_IMPORTED_MODULE_0___default().createElement(be,{skipIndex:P,options:x,onClick:(o,d)=>te(d)}):Ne?react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li",{onClick:re,className:"select-item creatable",tabIndex:P===1?0:1,ref:ne},`${e("create")} "${p}"`):react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li",{className:"no-options"},e("noOptions"))))},J=Xe;var Se=({expanded:e})=>react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg",{width:"24",height:"24",fill:"none",stroke:"currentColor",strokeWidth:"2",className:"dropdown-heading-dropdown-arrow gray"},react__WEBPACK_IMPORTED_MODULE_0___default().createElement("path",{d:e?"M18 15 12 9 6 15":"M6 9L12 15 18 9"}));var Ce=()=>{let{t:e,value:r,options:t,valueRenderer:n}=O(),a=r.length===0,c=r.length===t.length,u=n&&n(r,t);return a?react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span",{className:"gray"},u||e("selectSomeItems")):react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span",null,u||(c?e("allItemsAreSelected"):(()=>r.map(s=>s.label).join(", "))()))};var we=({size:e=24})=>react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span",{style:{width:e,marginRight:"0.2rem"}},react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg",{width:e,height:e,className:"spinner",viewBox:"0 0 50 50",style:{display:"inline",verticalAlign:"middle"}},react__WEBPACK_IMPORTED_MODULE_0___default().createElement("circle",{cx:"25",cy:"25",r:"20",fill:"none",className:"path"})));var et=()=>{let{t:e,onMenuToggle:r,ArrowRenderer:t,shouldToggleOnHover:n,isLoading:a,disabled:c,onChange:u,labelledBy:b,value:s,isOpen:m,defaultIsOpen:i,ClearSelectedIcon:l,closeOnChangedValue:W}=O();(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{W&&p(!1)},[s]);let[C,k]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(!0),[g,p]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(i),[D,x]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(!1),_=t||Se,y=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)();de(()=>{r&&r(g)},[g]),(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{i===void 0&&typeof m=="boolean"&&(k(!1),p(m))},[m]);let T=h=>{var N;["text","button"].includes(h.target.type)&&[f.SPACE,f.ENTER].includes(h.code)||(C&&(h.code===f.ESCAPE?(p(!1),(N=y==null?void 0:y.current)==null||N.focus()):p(!0)),h.preventDefault())};E([f.ENTER,f.ARROW_DOWN,f.SPACE,f.ESCAPE],T,{target:y});let I=h=>{C&&n&&p(h)},A=()=>!D&&x(!0),R=h=>{!h.currentTarget.contains(h.relatedTarget)&&C&&(x(!1),p(!1))},P=()=>I(!0),H=()=>I(!1),B=()=>{C&&p(a||c?!1:!g)},U=h=>{h.stopPropagation(),u([]),C&&p(!1)};return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{tabIndex:0,className:"dropdown-container","aria-labelledby":b,"aria-expanded":g,"aria-readonly":!0,"aria-disabled":c,ref:y,onFocus:A,onBlur:R,onMouseEnter:P,onMouseLeave:H},react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"dropdown-heading",onClick:B},react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"dropdown-heading-value"},react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Ce,null)),a&&react__WEBPACK_IMPORTED_MODULE_0___default().createElement(we,null),s.length>0&&l!==null&&react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button",{type:"button",className:"clear-selected-button",onClick:U,disabled:c,"aria-label":e("clearSelected")},l||react__WEBPACK_IMPORTED_MODULE_0___default().createElement(F,null)),react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_,{expanded:g})),g&&react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"dropdown-content"},react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"panel-content"},react__WEBPACK_IMPORTED_MODULE_0___default().createElement(J,null))))},Z=et;var tt=e=>react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ce,{props:e},react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:`rmsc ${e.className||"multi-select"}`},react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Z,null))),rt=tt;
...
"use strict";
/*!***********************************************!*\
  !*** ./assets/scripts/react/register/main.js ***!
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! prop-types */ "./node_modules/prop-types/index.js");
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./forms */ "./assets/scripts/react/register/forms.js");
...
const Step = props => {
  ...
  const currentStep = (_props$current = props.current) !== null && _props$current !== void 0 ? _props$current : 1;
  const [stepMax, setStepMax] = useState(5);
  let stepLinks = [];

  for (let i = 1; i < stepMax + 1; i++) {
    stepLinks.push((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
      className: i <= currentStep ? 'passed' : ''
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, i)));
  }

  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: 'steps'
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", null, stepLinks));
};
...
const Title = props => {
  ...
  const currentStep = (_props$current2 = props.current) !== null && _props$current2 !== void 0 ? _props$current2 : 1;
...
const App = () => {
  ...
  switch (currentStep) {
    case 1:
      usedForm = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: 'frow gutters mb-25 row-form'
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: 'col-sm-1-2'
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_forms__WEBPACK_IMPORTED_MODULE_1__.Input, {
        name: 'name',
        label: languagePacks.name
      })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: 'col-sm-1-2'
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_forms__WEBPACK_IMPORTED_MODULE_1__.Select, {
        name: 'gender',
        options: [languagePacks.male, languagePacks.female],
        label: languagePacks.gender
      })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: 'col-sm-1-2'
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_forms__WEBPACK_IMPORTED_MODULE_1__.Input, {
        name: 'pob',
        label: languagePacks.place_ob
      })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: 'col-sm-1-2'
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_forms__WEBPACK_IMPORTED_MODULE_1__.DateP, {
        label: languagePacks.date_ob
      })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: 'col-sm-2-2'
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_forms__WEBPACK_IMPORTED_MODULE_1__.Input, {
        name: 'address',
        label: languagePacks.address
      })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: 'col-sm-1-3'
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_forms__WEBPACK_IMPORTED_MODULE_1__.Select, {
        name: 'blood',
        options: ['A', 'B', 'AB', 'O'],
        label: languagePacks.blood
      })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: 'col-sm-1-3'
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_forms__WEBPACK_IMPORTED_MODULE_1__.Select, {
        name: 'marital',
        ...
        name: 'citizenship',
        options: [languagePacks.indonesian, languagePacks.foreigner],
        label: languagePacks.citizenship
      }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: 'frow gutters row-end row-action'
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: 'col-sm-1-3'
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_forms__WEBPACK_IMPORTED_MODULE_1__.Button, {
        label: languagePacks.continue,
        type: 'primary',
        callback: e => {
          setCurrentStep(2);
          setIsLoaded(false);
    ...
    case 2:
      usedForm = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        ...
        className: 'col-sm-1-1'
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_forms__WEBPACK_IMPORTED_MODULE_1__.SelectMultiple, {
        label: 'Skills',
        options: skills
      }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: 'frow gutters row-end row-action'
    ...
    switch (currentStep) {
      case 1:
        if (isEmpty(languagePacks)) {
          wp.ajax.send(rlw.prefix + 'languages', {}).done(result => {
      ...
      case 2:
        if (skills.length <= 0) {
          wp.ajax.send(rlw.prefix + 'skills', {}).done(result => {
            setSkills(result);
            setIsLoaded(true);
          });
        } else {
  ...
  const usedContent = isLoaded ? usedForm : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_forms__WEBPACK_IMPORTED_MODULE_1__.Loading, null);
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Step, {
    current: currentStep
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
wp.element.render((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(App, null), document.getElementById("registerPage"));
}();
/******/ })()
;
//# sourceMappingURL=reactRegister.min.js.map