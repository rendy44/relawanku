    ...
    onGenerateQRCode() {
      $('#gen-qrcode').click(e => {
        const wrapper = $(e.target).closest('div'),
              ...
              postId = $(e.target).closest('.rwmb-meta-box').data('object-id'); // Change loading state.

        $(e.target).prop('disabled', true).html('Loading...'); // Load all offices for the first time.
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            $(e.target).prop('disabled', false).html(originalLoadingText); // Validate result.
